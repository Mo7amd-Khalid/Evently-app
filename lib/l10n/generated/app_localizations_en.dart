...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get onboardingMessage2 => 'Take the hassle out of organizing events with our all-in-one planning tools. From setting up invites and managing RSVPs to scheduling reminders and coordinating details, we’ve got you covered. Plan with ease and focus on what matters – creating an unforgettable experience for you and your guests.';

  @override
  String get onboardingTitle3 => 'Connect with Friends & Share Moments';

  @override
  String get onboardingMessage3 => 'Make every event memorable by sharing the experience with others. Our platform lets you invite friends, keep everyone in the loop, and celebrate moments together. Capture and share the excitement with your network, so you can relive the highlights and cherish the memories.';
  ...
  @override
  String get passwordInvalid => 'Password must be at least 8 characters, include uppercase, lowercase, number, and special character';
  ...
  @override
  String get loginError => 'The email or password isn`t correct. Please try again';

  @override
  String get loginSuccess => 'Login done successfully';
